...
<head>
  ...
  <!-- Font Awesome Icons -->
  <link href="<c:url value="../resources/home/vendor/fontawesome-free/css/all.min.css"/>" rel="stylesheet" type="text/css">
  ...
  <!-- Plugin CSS -->
  <link href="<c:url value="../resources/home/vendor/magnific-popup/magnific-popup.css"/>" rel="stylesheet">

  <!-- Theme CSS - Includes Bootstrap -->
  <link href="<c:url value="../resources/home/css/creative.min.css"/>" rel="stylesheet">
  <link href="<c:url value="../resources/home/css/creative.css"/>" rel="sylesheet">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="">Obyek Wisata</a>
          </li>
          <li class="nav-item">
  ...
  <div class="menulist">
        <ul>
            ...
            <div style="float:right;">
	            <li><a href="${pageContext.request.contextPath}/login">Keluar</a></li>
            </div>
        </ul>
  </div>
